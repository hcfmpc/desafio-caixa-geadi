        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    nu_id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    no_arquivo = table.Column<string>(type: "varchar(max)", unicode: false, nullable: false),
                    no_local = table.Column<string>(type: "varchar(max)", unicode: false, nullable: false),
